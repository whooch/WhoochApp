...
public class ReactionsActivity extends SherlockListActivity implements OnScrollListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh() {
                WhoochApiCallTask task = new WhoochApiCallTask(getActivityContext(), new ReactionsInitiate(), false);
                task.execute();
            }
        });
    ...
    public void onResume() {
        ...
        WhoochApiCallTask task = new WhoochApiCallTask(getActivityContext(), new ReactionsInitiate(), true);
        task.execute();
    }
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        if (mReactionsInitiated && mReactionsHasMoreUpdates && !mLoadMoreItemsInProgress) {
            
            int numPaddingItems = 0;
            if (firstVisibleItem + visibleItemCount + numPaddingItems >= totalItemCount) {
                
                mLoadMoreItemsInProgress = true;
                WhoochApiCallTask task = new WhoochApiCallTask(getActivityContext(), new ReactionsGetMoreUpdates(), false);
                task.execute();
    ...
    private class ReactionsInitiate implements WhoochApiCallInterface {
        ...
        public HttpRequestBase getHttpRequest() {
            return new HttpGet(Settings.apiUrl + "/reactions/1?page=0&type=user&received=true");
        }
        ...
        public void postExecute(int statusCode) {
            ...
            if (statusCode == 200) {
                ...
                // if it is less than 25 then we should stop trying to get more updates
    ...
    private class ReactionsGetMoreUpdates implements WhoochApiCallInterface {
        ...
        public HttpRequestBase getHttpRequest() {
            return new HttpGet(Settings.apiUrl + "/feedback/1?page=" + mReactionsNextPage + "&type=user&received=true");
        }
        ...
        public void postExecute(int statusCode) {
            ...
            // if it is less than 10 then we should stop trying to get more updates
