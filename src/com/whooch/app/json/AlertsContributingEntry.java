...
public class AlertsContributingEntry extends AlertsEntry {
    ...
    public AlertsContributingEntry() {
        super();
    }
    
    public AlertsContributingEntry(JSONObject json, WindowManager windowMgr, AlertsActivity parentActivity) {        
        super(json);
        ...
        return new OnClickListener() {
            ...
            public void onClick(View v) {
                WhoochApiCallTask task = new WhoochApiCallTask(mParentActivity.getActivityContext(),
                                                               new ConfirmContributingRequest(), false);
                task.execute();
            }
        };
    }
    ...
    public OnClickListener getDeclineClickListener() {
        return new OnClickListener() {
            ...
            public void onClick(View v) {
                WhoochApiCallTask task = new WhoochApiCallTask(mParentActivity.getActivityContext(),
                                                               new DeclineContributingRequest(), false);
                task.execute();
            }
        };
    }
